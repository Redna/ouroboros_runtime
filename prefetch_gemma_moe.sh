...
echo "Starting resilient download for Gemma-4-26B-A4B weights..."
until hf download unsloth/gemma-4-26B-A4B-it-GGUF gemma-4-26B-A4B-it-UD-Q4_K_XL.gguf --local-dir ./models; do
    echo "Model download interrupted. Retrying in 5 seconds..."
    sleep 5
done

echo "Starting resilient download for Vision Projector..."
until hf download unsloth/gemma-4-26B-A4B-it-GGUF mmproj-BF16.gguf --local-dir ./models; do
